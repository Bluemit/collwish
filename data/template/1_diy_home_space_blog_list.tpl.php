...
0
|| checktplrefresh('./template/default/home/space_blog_list.htm', './template/default/home/space_header.htm', 1463502005, 'diy', './data/template/1_diy_home_space_blog_list.tpl.php', './template/default', 'home/space_blog_list')
|| checktplrefresh('./template/default/home/space_blog_list.htm', './template/default/common/userabout.htm', 1463502005, 'diy', './data/template/1_diy_home_space_blog_list.tpl.php', './template/default', 'home/space_blog_list')
|| checktplrefresh('./template/default/home/space_blog_list.htm', './template/default/home/space_userabout.htm', 1463502005, 'diy', './data/template/1_diy_home_space_blog_list.tpl.php', './template/default', 'home/space_blog_list')
|| checktplrefresh('./template/default/home/space_blog_list.htm', './template/default/common/header_common.htm', 1463502005, 'diy', './data/template/1_diy_home_space_blog_list.tpl.php', './template/default', 'home/space_blog_list')
|| checktplrefresh('./template/default/home/space_blog_list.htm', './template/default/home/space_diy.htm', 1463502005, 'diy', './data/template/1_diy_home_space_blog_list.tpl.php', './template/default', 'home/space_blog_list')
|| checktplrefresh('./template/default/home/space_blog_list.htm', './template/default/home/space_header_personalnv.htm', 1463502005, 'diy', './data/template/1_diy_home_space_blog_list.tpl.php', './template/default', 'home/space_blog_list')
;?>
<?php $_G[home_tpl_spacemenus][] = "<a href=\"home.php?mod=space&amp;uid=$space[uid]&amp;do=blog&amp;view=me\">TA 的所有日志</a>";
$friendsname = array(1 => '仅好友可见',2 => '指定好友可见',3 => '仅自己可见',4 => '凭密码可见');?><?php if($diymode) { if($_G['setting']['homepagestyle']) { $_G[cookie][extstyle] = false;?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="bm">
<div class="bm_h">
<?php if($space['self'] && helper_access::check_module('blog')) { ?><span class="xi2 y"> <a href="home.php?mod=spacecp&amp;ac=blog" class="addnew">发表新日志</a></span><?php } ?>
<h1 class="mt">日志</h1>
</div>
<div class="bm_c">
...
<!--[diy=diycontenttop]--><div id="diycontenttop" class="area"></div><!--[/diy]-->
<div class="bm bw0">
<h1 class="mt"><img alt="blog" src="<?php echo STATICURL;?>image/feed/blog.gif" class="vm" /> 日志</h1>
<ul class="tb cl">
...
<dt class="xs2"><?php $stickflag = isset($value['stickflag']) ? 0 : 1;?><?php if(!$stickflag) { ?><span class="xi1">置顶</span> &middot;<?php } if(helper_access::check_module('share')) { ?>
...
<span class="pipe">|</span><a href="home.php?mod=spacecp&amp;ac=blog&amp;blogid=<?php echo $value['blogid'];?>&amp;op=edit">编辑</a><span class="pipe">|</span>
