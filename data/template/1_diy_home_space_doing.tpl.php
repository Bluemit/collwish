...
0
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_header.htm', 1463730987, 'diy', './data/template/1_diy_home_space_doing.tpl.php', './template/default', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/common/userabout.htm', 1463730987, 'diy', './data/template/1_diy_home_space_doing.tpl.php', './template/default', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_userabout.htm', 1463730987, 'diy', './data/template/1_diy_home_space_doing.tpl.php', './template/default', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/common/header_common.htm', 1463730987, 'diy', './data/template/1_diy_home_space_doing.tpl.php', './template/default', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_diy.htm', 1463730987, 'diy', './data/template/1_diy_home_space_doing.tpl.php', './template/default', 'home/space_doing')
|| checktplrefresh('./template/default/home/space_doing.htm', './template/default/home/space_header_personalnv.htm', 1463730987, 'diy', './data/template/1_diy_home_space_doing.tpl.php', './template/default', 'home/space_doing')
;?>
<?php if($diymode) { if($_G['setting']['homepagestyle']) { $_G[cookie][extstyle] = false;?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="bm bw0">
<div class="bm_c">
<?php } if($space['self'] && helper_access::check_module('doing')) { include template('home/space_doing_form'); } } else { include template('common/header'); ?><div id="pt" class="bm cl">
<div class="z">
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em>
...
<p class="tbmu">以下是搜索记录 <span style="color: red; font-weight: 700;"><?php echo $searchkey;?></span> 结果列表</p>
<?php } if($dolist) { ?>
<div class="xld <?php if(empty($diymode)) { ?>xlda<?php } ?>"><?php if(is_array($dolist)) foreach($dolist as $dv) { $doid = $dv[doid];?><?php $_GET[key] = $key = random(8);?><dl id="<?php echo $key;?>dl<?php echo $doid;?>" class="pbn bbda cl">
...
<dd class="<?php if(empty($diymode)) { ?>ptm<?php } else { ?>ptw<?php } ?> xs2">
<?php if(empty($diymode)) { ?><a href="home.php?mod=space&amp;uid=<?php echo $dv['uid'];?>"><?php echo $dv['username'];?></a>: <?php } ?><span><?php echo $dv['message'];?></span> <?php if($dv['status'] == 1) { ?> <span style="font-weight: bold;">(待审核)</span><?php } ?>
