...
0
|| checktplrefresh('./template/default/home/space_wall.htm', './template/default/home/space_header.htm', 1463730957, '1', './data/template/1_1_home_space_wall.tpl.php', './template/default', 'home/space_wall')
|| checktplrefresh('./template/default/home/space_wall.htm', './template/default/home/space_userabout.htm', 1463730957, '1', './data/template/1_1_home_space_wall.tpl.php', './template/default', 'home/space_wall')
|| checktplrefresh('./template/default/home/space_wall.htm', './template/default/common/header_common.htm', 1463730957, '1', './data/template/1_1_home_space_wall.tpl.php', './template/default', 'home/space_wall')
|| checktplrefresh('./template/default/home/space_wall.htm', './template/default/home/space_diy.htm', 1463730957, '1', './data/template/1_1_home_space_wall.tpl.php', './template/default', 'home/space_wall')
|| checktplrefresh('./template/default/home/space_wall.htm', './template/default/home/space_header_personalnv.htm', 1463730957, '1', './data/template/1_1_home_space_wall.tpl.php', './template/default', 'home/space_wall')
;?>
<?php $_G['home_tpl_titles'] = array('留言板');?><?php if($_G['setting']['homepagestyle']) { $_G[cookie][extstyle] = false;?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<form id="quickcommentform_<?php echo $space['uid'];?>" action="home.php?mod=spacecp&amp;ac=comment" method="post" autocomplete="off" onsubmit="ajaxpost('quickcommentform_<?php echo $space['uid'];?>', 'return_qcwall_<?php echo $space['uid'];?>');doane(event);">
<p>
